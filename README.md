...
When using the alarm input the external drivers need to be configured for open-drain, active-lown put.  The alarmmoutput must be high impedance during normal operation.
